...
export default function GlobalError(props:Props) {
    ...
    return (
        <div id="global_error" className={`${visibility ? 'global_animation_enabled' : 'global_animation_disabled'} fixed flex z-50 w-72 h-12 pl-4 rounded-sm`} style={{backgroundColor:'#FEF2F2'}}>
            <div className="flex items-center nowrap whitespace-nowrap">
                <div className="bg-red-300 rounded-full flex items-center justify-center mr-4 nowrap whitespace-nowrap" style={{height:'1.4rem',width:'1.4rem'}}>
