                ...
                <div className='pt-24'>
                    ...
                    <div className='mt-12'>
                        {reviews.length > 0 ?
                            ...
                            <div className='text-md text-white font-semibold opacity-30'>No Reviews</div>
                        }
                    </div>
                </div>
                <div className='pt-14'>
                    ...
                    <div className='mt-12'>
                        {favorites.length > 0 ?
                            ...
                            <div className='text-md text-white font-semibold opacity-30'>No Favorite Games</div>
                        }
                    </div>
                </div>
            </main>
