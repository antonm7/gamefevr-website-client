            ...
            >
                <div className="flex items-center">
                    ...
                    <h1
                        ...
                        className="font-semibold text-lg cursor-pointer text-white whitespace-pre-wrap hover:text-gray-300 px-6 py-3"
                    >
                        {props.game_name}
                    </h1>
                </div>
                <h1 className="inline font-semibold text-lg cursor-pointer text-white opacity-70 whitespace-pre-wrap hover:text-gray-300 py-1">
                    {props.rank}
                </h1>
                <p
